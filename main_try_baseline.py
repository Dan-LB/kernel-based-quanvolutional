...
folder_name = "Full_dataset_rPQC"

create_and_process(n=70000, size = 28, model = quanvPQC_model, folder_name=folder_name)
...
for epoch in range(1, 100000):  # 100 epochs
