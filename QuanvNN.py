...
class QuanvNN(nn.Module):
    def __init__(self, n_circuits = 5, n_shots = 10, verbose = True):
        super(QuanvNN, self).__init__()
        self.quanv = Quanv2D(1, n_circuits, kernel_size=3, n_shots=n_shots, verbose = verbose)
        #self.conv1 = nn.Conv2d(10, 50, kernel_size=5, padding=0)
        self.conv2 = nn.Conv2d(n_circuits, 64, kernel_size=5, padding=1)
