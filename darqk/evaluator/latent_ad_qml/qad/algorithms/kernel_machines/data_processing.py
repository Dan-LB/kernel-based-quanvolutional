...
def get_data(args: dict, print_info = True) -> Tuple:
...
def h5_to_ml_ready_numpy(file_path: str, print_info = False) -> np.ndarray:
...
def reshaper(array: np.ndarray, print_info = False) -> np.ndarray:
...
def get_train_dataset(
    ...
    bkg: np.ndarray,
    ntrain: int,
    is_unsup: bool, print_info = False
