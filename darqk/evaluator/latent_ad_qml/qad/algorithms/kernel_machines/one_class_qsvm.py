...
class OneClassQSVM(OneClassSVM):
    ...
    def __init__(self, hpars: dict, use_custom_kernel = False, kernel = None):
    ...
    def fit(self, train_data: np.ndarray, train_labels=None):
        ...
        #print("Cercando errori: one_class_qsvm, riga159")
    ...
    def get_transpiled_kernel_circuit(
        ...
        **kwargs: dict,
        ...
        qc_kernel_circuit = self._quantum_kernel.feature_map
